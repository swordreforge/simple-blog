...
(uploadArea.addEventListener('click', () => {
  ...
  document.getElementById('uploadForm').addEventListener('submit', async function (e) {
    ...
    if (t) {
      ...
      if (n) {
        const i = document.querySelector('#uploadCategorySelector .category-option.selected'),
          l = i ? i.dataset.categoryName : '',
          m = [],
          u =
            ...
            if (i && 0 !== i.trim().length) {
              ...
              var d = localStorage.getItem('auth_token'),
                ...
                s =
                  ...
                  { title: t, content: i, author: n, category: l, tags: m.join(','), status: o }),
                r =
                  (v && (s.created_at = v),
                  await (
              ...
              if (r.success) {
                ...
                for (const s of a)
                  try {
                    const e = new FormData(),
                      ...
                      r = await a.json();
                    r.success ? n++ : (o++, c.push(s.name + ': ' + (r.message || '未知错误')));
                  } catch (e) {
                ...
                ((u.textContent = g),
                  (u.disabled = !1),
                  showToast('创建失败：' + (r.message || '未知错误'), 'error'));
            } else
