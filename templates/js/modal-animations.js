function closeModalWithAnimation(o) {
  o &&
...
function closeAllModals() {
  document.querySelectorAll('.modal.active').forEach(o => {
    closeModalWithAnimation(o);
  });
}
function initModalAnimations() {
  (document.addEventListener('keydown', function (o) {
    'Escape' === o.key && closeAllModals();
  }),
    document.querySelectorAll('.modal').forEach(o => {
      var t = o.querySelector('.modal-content');
      (t &&
    ...
    document.querySelectorAll('.modal-close').forEach(o => {
      o.addEventListener('click', function () {
        var o;
        (o = (o = this.getAttribute('data-modal'))
          ? document.getElementById(o)
          : this.closest('.modal')) && closeModalWithAnimation(o);
      });
    }));
}
