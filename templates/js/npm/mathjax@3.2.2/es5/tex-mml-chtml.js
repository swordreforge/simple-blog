 ...
 * Original file: /npm/mathjax@3.2.2/es5/node-main.js
 *
  ...
  var __webpack_modules__ = {
              ...
              try {
                for (var o = i(e.reverse()), a = o.next(); !a.done; a = o.next()) {
                  ...
                  try {
                    ...
                    console.warn(
                      "MathJax: can't insert css rule '".concat(s, "': ").concat(t.message)
                    );
                  }
                }
              } catch (t) {
      ...
      1131: function (t, e, r) {
        ...
        ((e.NodeMixinOptions = { badCSS: !0, badSizes: !0 }),
          (e.NodeMixin = function (t, r) {
            ...
            return (
              void 0 === r && (r = {}),
              (r = (0, a.userOptions)((0, a.defaultOptions)({}, e.NodeMixinOptions), r)),
              (n = (function (t) {
                function e() {
                  ...
                  var n = t.call(this, e[0]) || this,
                    o = n.constructor;
                  return (
                    (n.options = (0, a.userOptions)((0, a.defaultOptions)({}, o.OPTIONS), e[1])),
                    n
                  );
                }
                return (
                  ...
                  (e.prototype.fontSize = function (e) {
                    return r.badCSS ? this.options.fontSize : t.prototype.fontSize.call(this, e);
                  }),
              ...
              (n.OPTIONS = i(
                ...
                r.badSizes ? { cjkCharWidth: 1, unknownCharWidth: 0.6, unknownCharHeight: 0.8 } : {}
              )),
      ...
      5020: function (t, e, r) {
        ...
        !(function (t) {
          ((t.TAGNAME = '[a-z][^\\s\\n>]*'),
            ...
            (t.OPTIONALSPACE = '(?:\\s|\\n)*'),
            (t.ATTRIBUTE =
              t.ATTNAME + '(?:' + t.OPTIONALSPACE + '=' + t.OPTIONALSPACE + t.VALUE + ')?'),
            (t.ATTRIBUTESPLIT =
              '(' +
              t.ATTNAME +
              ')(?:' +
        ...
        var f = (function () {
          ...
          return (
              ...
              if (a) {
                try {
                  for (var l = s(t.childNodes(t.body(e))), c = l.next(); !c.done; c = l.next()) {
                    ...
                    h instanceof p.LiteComment && h.value.match(/^<!DOCTYPE/) && (e.type = h.value);
                  }
                } catch (t) {
                  r = { error: t };
                } finally {
            ...
            (t.prototype.serialize = function (t, e, r) {
              ...
              var o = this.constructor.SELF_CLOSING,
                ...
                s = t
                  ...
                  .map(function (t) {
                    return (
                      t.name + '="' + (i[t.name] ? t.value : n.protectAttribute(t.value)) + '"'
                    );
                  })
                  .join(' '),
            ...
            (t.prototype.protectAttribute = function (t) {
              return ('string' != typeof t && (t = String(t)), t.replace(/"/g, '&quot;'));
            }),
        ...
        var c = r(5009),
          ...
          m = (function (t) {
            ...
            return (
                    ...
                    if ('string' == typeof c)
                      if ('#' === c.charAt(0)) {
                        ...
                        '.' === c.charAt(0)
                          ...
                          : c.match(/^[-a-z][-a-z0-9]*$/i) && (o = o.concat(this.tags(i, c)));
                    else
                      Array.isArray(c)
                        ? (o = o.concat(c))
              ...
              (e.prototype.append = function (t, e) {
                return (e.parent && this.remove(e), t.children.push(e), (e.parent = t), e);
              }),
              (e.prototype.insert = function (t, e) {
              ...
              (e.prototype.replace = function (t, e) {
                var r = this.childIndex(e);
                return (
                  r >= 0 && ((e.parent.children[r] = t), (t.parent = e.parent), (e.parent = null)),
                  e
                );
              }),
              (e.prototype.clone = function (t) {
                ...
                return (
                  ...
                  (r.children = t.children.map(function (t) {
                    ...
                    if ('#comment' === t.kind) return new h.LiteComment(t.value);
                    var n = e.clone(t);
                    return ((n.parent = r), n);
                  })),
                  r
              ...
              (e.prototype.textContent = function (t) {
                ...
                return t.children.reduce(function (t, r) {
                  return (
                    t +
                    ('#text' === r.kind ? r.value : '#comment' === r.kind ? '' : e.textContent(r))
                  );
                }, '');
              }),
              (e.prototype.innerHTML = function (t) {
              ...
              (e.prototype.setStyle = function (t, e, r) {
                (t.styles || (t.styles = new O.Styles(this.getAttribute(t, 'style'))),
                  t.styles.set(e, r),
      ...
      235: function (t, e, r) {
        ...
        if (
          ((e.PathFilters = {
            source: function (t) {
              return (
                e.CONFIG.source.hasOwnProperty(t.name) && (t.name = e.CONFIG.source[t.name]),
                !0
              );
            },
            ...
            prefix: function (t) {
              for (
                var r;
                (r = t.name.match(/^\[([^\]]*)\]/)) && e.CONFIG.paths.hasOwnProperty(r[1]);
              )
                      ...
                      l.push(
                        n.promise.then(function () {
                          e.CONFIG.versionWarnings &&
                            ...
                            console.warn(
                              'No version information available for component '.concat(r)
                            );
                        })
                      ));
                  };
        ...
        var u = (function () {
          ...
          return (
            Object.defineProperty(t.prototype, 'canLoad', {
              get: function () {
                return (
                  0 === this.dependencyCount && !this.noLoad && !this.isLoading && !this.hasFailed
                );
              },
              enumerable: !1,
              configurable: !0,
      ...
      2388: function (t, e, r) {
        ...
        (!(function (t) {
          ...
          function h() {
            ((s = new e.MathJax._.core.MmlTree.SerializedMmlVisitor.SerializedMmlVisitor()),
          ...
          function L(r) {
            return (
              ...
              l.document(
                r || e.CONFIG.document,
                n(n({}, e.MathJax.config.options), { InputJax: t.input, OutputJax: t.output })
              )
            );
          }
          ((t.constructors = {}),
            ...
            return (
              ...
              (t.prototype.convert = function (t, e) {
                ...
                return (
                  ...
                  this.outputJax.options.merrorInheritFont && (y.outputData.merrorFamily = h),
                  y.convert(this, i),
              ...
              (t.prototype.reset = function (t) {
                ...
                return (
                  ...
                  (t = (0, l.userOptions)(Object.assign({}, e.resetOptions), t)).all &&
                  ...
                  t.outputJax && (r = this.outputJax).reset.apply(r, s([], a(t.outputJax), !1)),
                  this
                );
              }),
      ...
      4474: function (t, e) {
        (Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          (e.protoItem = function (t, e, r, n, o, i, a) {
            return (
              void 0 === a && (a = null),
              { open: t, math: e, close: r, n: n, start: { n: o }, end: { n: i }, display: a }
            );
          }));
        var r = (function () {
          ...
          return (
            ...
            (t.prototype.compile = function (t) {
              this.state() < e.STATE.COMPILED &&
                ((this.root = this.inputJax.compile(this, t)), this.state(e.STATE.COMPILED));
            }),
      ...
      9007: function (t, e, r) {
        ...
        var f = (function (t) {
          function r(e, r, n) {
            ...
            return (
              ...
              (o.texclass = null),
              o.arity < 0 &&
                ((o.childNodes = [e.create('inferredMrow')]), (o.childNodes[0].parent = o)),
              o.setChildren(n),
          ...
          return (
            ...
            (r.prototype.verifyAttributes = function (t) {
              ...
              if (t.checkAttributes) {
                ...
                o.length &&
                  this.mError('Unknown attributes for ' + this.kind + ' node: ' + o.join(', '), t);
              }
            }),
        ...
        var h = (function (t) {
          ...
          return (
            ...
            (e.defaults = i(i({}, f.defaults), { mathvariant: 'normal', mathsize: l.INHERIT })),
            e
          );
        })(f);
        ...
        var a = r(9007),
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.defaults = i(i({}, a.AbstractMmlLayoutNode.defaults), { groupalign: s.INHERIT })),
              e
            );
        ...
        var a = r(9007),
          s = (function (t) {
            ...
            return (
              ...
              (e.defaults = i(i({}, a.AbstractMmlNode.defaults), { notation: 'longdiv' })),
              e
            );
          })(a.AbstractMmlNode);
        e.MmlMenclose = s;
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.setChildInheritedAttributes = function (e, r, n, o) {
                ...
                try {
                  for (
                    var l = a([this.open, this.close].concat(this.separators)), c = l.next();
                    !c.done;
                    c = l.next()
                  ) {
                    var u = c.value;
              ...
              (e.prototype.addFakeNodes = function () {
                ...
                if (
                  ...
                  (i = i.replace(/[ \t\n\r]/g, '')),
                  n &&
                    (this.open = this.fakeNode(n, { fence: !0, form: 'prefix' }, s.TEXCLASS.OPEN)),
                  i)
                ) {
                ...
                o &&
                  (this.close = this.fakeNode(o, { fence: !0, form: 'postfix' }, s.TEXCLASS.CLOSE));
              }),
            ...
            (e.prototype.verifyTree = function (e) {
              (t.prototype.verifyTree.call(this, e),
                this.parent &&
                  ...
                  this.mError(this.kind + ' must be a child of mmultiscripts', e, !0));
            }),
            (e.defaults = i({}, a.AbstractMmlNode.defaults)),
            e
          );
            ...
            return (
              ...
              (e.prototype.coreText = function (t) {
                ...
                for (
                  ;
                  (((t.isKind('mrow') ||
                    (t.isKind('TeXAtom') && t.texClass !== l.TEXCLASS.VCENTER) ||
                    t.isKind('mstyle') ||
                    t.isKind('mphantom')) &&
              ...
              Object.defineProperty(e.prototype, 'isAccent', {
                get: function () {
                  ...
                  if (e) {
                    ...
                    if (r)
                      t =
                        void 0 !== e.attributes.getExplicit(r) ? t : this.attributes.get('accent');
                  }
                  return t;
                },
                enumerable: !1,
              ...
              (e.prototype.adjustTeXclass = function (t) {
                ...
                if (
                  ...
                  if (
                    r !== l.TEXCLASS.BIN ||
                    (e !== l.TEXCLASS.REL && e !== l.TEXCLASS.CLOSE && e !== l.TEXCLASS.PUNCT)
                  ) {
                    if (e === l.TEXCLASS.BIN) {
                      for (
                        ...
                        o.parent &&
                        o.isEmbellished &&
                        (1 === o.childNodes.length || (!o.isKind('mrow') && o.core() === n));
                      )
                        ((n = o), (o = o.parent));
                ...
                try {
                  for (var u = a(this.childNodes), p = u.next(); !p.done; p = u.next()) {
                    (O = p.value).isKind('mtr') ||
                      this.replaceChild(this.factory.create('mtr'), O).appendChild(O);
                  }
                } catch (t) {
                  o = { error: t };
                } finally {
                ...
                if (null == this.attributes.getExplicit(e) && a.isEmbellished) {
                  ...
                  (this.attributes.setInherited(e, s),
                    s !== this.attributes.getDefault(e) &&
                      a.setInheritedAttributes({}, r, this.getScriptlevel(e, i, n), o));
                }
              }),
              (e.defaults = i(i({}, a.AbstractMmlBaseNode.defaults), {
                accent: !1,
      ...
      4082: function (t, e, r) {
        ...
        ((e.OPDEF = i),
          (e.MO = {
            ...
            OP: i(1, 2, o.TEXCLASS.OP, { largeop: !0, movablelimits: !0, symmetric: !0 }),
            ...
            CLOSE: i(0, 0, o.TEXCLASS.CLOSE, { fence: !0, stretchy: !0, symmetric: !0 }),
          ...
          s = (function () {
            ...
            return (
              ...
              (t.prototype.visitDefault = function (t) {
                for (var e, r, s = [], l = 1; l < arguments.length; l++) s[l - 1] = arguments[l];
            ...
            return (
              ...
              (e.prototype.findMath = function (t) {
                ...
                if (!this.processed.isSet('findMath')) {
                  ...
                  try {
                    for (
                      var h = s(this.adaptor.getElements(t.elements, this.document)), d = h.next();
                      !d.done;
                      d = h.next()
                    ) {
                      var y = d.value,
                      ...
                      try {
                        for (
                          var M = ((n = void 0), s(this.inputJax)), b = M.next();
                          !b.done;
                          b = M.next()
                        ) {
                          var E = b.value,
                          ...
                          if (E.processStrings) {
                            null === m &&
                              ((m = (i = a(this.domStrings.find(y), 2))[0]), (v = i[1]));
                            try {
                              for (
                                var L = ((l = void 0), s(E.findMath(m))), x = L.next();
                                !x.done;
                                x = L.next()
                              ) {
                                var N = x.value;
                            ...
                            try {
                              for (
                                var _ = ((p = void 0), s(E.findMath(y))), T = _.next();
                                !T.done;
                                T = _.next()
                              ) {
                                N = T.value;
          ...
          i = (function () {
            ...
            return (
              ...
              (t.prototype.find = function (t) {
                ...
                this.init();
                for (
                  var o = this.adaptor.next(t), i = !1, a = this.options.includeHtmlTags;
                  t && t !== o;
                ) {
      ...
      5368: function (t, e, r) {
        ...
        function a(t, r) {
          ...
          if (e.options.loadMissingEntities) {
            ...
            i[a] ||
              ((i[a] = !0), (0, n.retryAfter)((0, o.asyncLoad)('./util/entities/' + a + '.js')));
          }
          return t;
        }
        function s(t) {
          ...
          return (
            ...
            (t.prototype.remove = function () {
              ...
              for (var u = this.list.next; u.data !== e.END; ) {
                var p = u.next;
                (a.has(u.data) &&
                  ((u.prev.next = u.next), (u.next.prev = u.prev), (u.next = u.prev = null)),
                  (u = p));
              }
            }),
            (t.prototype.clear = function () {
      ...
      7233: function (t, e) {
        ...
        ((e.Expandable = s),
          ...
          (e.separateOptions = function (t) {
            for (var e, n, o, i, a = [], s = 1; s < arguments.length; s++) a[s - 1] = arguments[s];
            var l = [];
            try {
              for (var c = r(a), u = c.next(); !u.done; u = c.next()) {
                ...
                try {
                  for (
                    var d = ((o = void 0), r(Object.keys(t || {}))), y = d.next();
                    !y.done;
                    y = d.next()
                  ) {
                    var O = y.value;
      ...
      8054: function (t, e) {
        ...
        function c(t) {
          ...
          (i[3] === i[1] && (i.pop(), i[2] === i[0] && (i.pop(), i[1] === i[0] && i.pop())),
        ...
        function p(t) {
          ...
          try {
            for (var l = r(a), c = l.next(); !c.done; c = l.next()) {
              var u = c.value;
              if (this.styles[this.childName(t, u)] !== s) return void delete this.styles[t];
            }
          } catch (t) {
            e = { error: t };
          } finally {
              ...
              try {
                for (
                  ...
                  if ((Array.isArray(c[y]) || '' === c[y]) && f.match(O[y]))
                    ...
                    } else '' === c.size && (Array.isArray(c[y]) ? c[y].push(f) : (c[y] = f));
                }
              } catch (t) {
                i = { error: t };
              } finally {
        ...
        var M = (function () {
          ...
          return (
            ...
            (t.prototype.setStyle = function (e, r) {
              ((this.styles[e] = r),
                t.connect[e] && t.connect[e].children && t.connect[e].split.call(this, e),
      ...
      8671: function (t, e, r) {
        ...
        var n = r(9515),
          ...
          u = r(2560),
          p = r(1248);
        (MathJax.loader && MathJax.loader.checkVersion('adaptors/liteDOM', o.VERSION, 'adaptors'),
          (0, n.combineWithMathJax)({
            _: {
              adaptors: {
                liteAdaptor: i,
                lite: { Document: a, Element: s, List: l, Parser: c, Text: u, Window: p },
              },
            },
          }),
          MathJax.startup &&
      ...
      1585: function (t, e, r) {
        ...
        (MathJax.loader && MathJax.loader.checkVersion('startup', o.VERSION, 'startup'),
          (0, n.combineWithMathJax)({ _: { components: { loader: i, package: a, startup: s } } }));
        var c,
          u = {
